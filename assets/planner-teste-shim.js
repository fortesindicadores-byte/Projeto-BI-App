...
(function (global) {
  ...
  const SEED = [
    ...
    ['Governança',      'Criar envio de faróis automáticos via e-mail',              'Renan Fortes',     dia(-1),  'Planning', 30],
    ['DPO/VPO',         'Validar cronograma viagens e apoio em auditorias',          'Katiuce Cordeiro', dia(-8),  'Planning', 25],
    ['Combustível',     'Verificar baixas faltantes do tanque interno de MCC',       'Emili Ariza',      dia(-1),  'Planning', 20],
    ['Governança',      'Marcar Reuniões de Custos e Indicadores',                   'Renan Fortes',     dia(2),   'Planning', 12],
    ['Conformidade da Frota', 'Validar conformidade com o Ginfo',                    'Pedro Pieroni',    dia(3),   'Planning', 10],
    ['Viagens',         'Revisar roteirização das viagens de apoio',                 'Felipe Monsores',  dia(9),   'Planning', 6],
    ['Manutenção',      'Recalcular R$/km Manutenção da Seara',                      'Pedro Pieroni',    dia(-8),  'Doing', 28],
    ['Combustível',     'Corrigir erro de abastecimentos duplicados',                'Pedro Pieroni',    dia(-8),  'Doing', 26],
    ['Contratos de Manutenção', 'Implementar módulo contratos no Benner',            'Emili Ariza',      dia(-1),  'Doing', 18],
    ['Xadrez de Frota', 'Desmobilizar placas de GRL e PIR',                          'Pedro Pieroni',    dia(13),  'Doing', 15],
    ['Processos',       'Padronizar abertura de OS na ponta',                        'Felipe Monsores',  dia(20),  'Doing', 9],
    ['Projetos',        'Desdobrar Projeto Integração Prolog/Ginfo - Benner',        'Katiuce Cordeiro', dia(114), 'Doing', 40],
    ['Governança',      'Montar material reunião PMO na sexta',                      'Pedro Pieroni',    dia(-9),  'Done',    35],
    ['Custos',          'Criar Carta de Custos centralizada no ecossistema de frota','Renan Fortes',     dia(-7),  'Done',    32],
    ['Governança',      'Divulgar Programa de Reconhecimento Frota de Elite',        'Renan Fortes',     dia(-7),  'Done',    31],
    ['Pneus',           'Fechar rotina de aferição com as unidades',                 'Pedro Pieroni',    dia(-5),  'Done',    22],
