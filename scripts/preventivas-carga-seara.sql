...
insert into public.preventiva_lanc (unidade, placa, escopo, tipo, data, km, obs) values
  ('ANG','EWZ4I53','frio','Básica','2026-06-19',null,'carga planilha da unidade'),
  ('ANG','EYY0A65','frio','Básica','2026-07-08',null,'carga planilha da unidade'),
  ('ANG','FWB6D72','frio','Básica','2026-07-07',null,'carga planilha da unidade'),
  ('ANG','GDP6H93','frio','Básica','2026-07-07',null,'carga planilha da unidade'),
  ('ANG','SWF3D53','frio','Básica','2026-05-07',null,'carga planilha da unidade'),
  ('ANG','BKG6B91','montadora','MP1','2026-03-11',137846,'carga planilha da unidade'),
  ...
  ('ANG','EWY0J65','montadora','MP1','2026-05-30',90456,'carga planilha da unidade'),
  ...
  ('ANG','FCC9A15','montadora','MP1','2026-04-22',106114,'carga planilha da unidade'),
  ('ANG','FEJ3G82','montadora','MP1','2026-06-02',116328,'carga planilha da unidade'),
  ('ANG','FIN6I77','montadora',null,'2025-05-07',101646,'carga planilha da unidade'),
  ('ANG','FIW2B57','montadora','MP1','2026-02-02',99309,'carga planilha da unidade'),
  ('ANG','FJN3B97','montadora','MP1','2026-02-03',129885,'carga planilha da unidade'),
  ('ANG','FJT7H24','montadora',null,'2025-05-14',79492,'carga planilha da unidade'),
  ('ANG','FLR5C32','montadora','MP1','2026-03-20',94788,'carga planilha da unidade'),
  ...
  ('ANG','FOF9E14','montadora','MP1','2026-05-07',119822,'carga planilha da unidade'),
  ('ANG','FPK4F12','montadora',null,'2025-04-11',91952,'carga planilha da unidade'),
  ('ANG','FQI9C63','montadora','MP1','2026-05-07',88984,'carga planilha da unidade'),
  ...
  ('ANG','FYF6D94','montadora','MP1','2026-05-07',115980,'carga planilha da unidade'),
  ('ANG','GBE1D74','montadora','MP1','2026-05-07',119974,'carga planilha da unidade'),
  ('ANG','GBU8J26','montadora','MP1','2026-02-18',112295,'carga planilha da unidade'),
  ...
  ('ANG','GDP6H93','montadora','MP1','2026-05-30',123456,'carga planilha da unidade'),
  ('ANG','GET3F84','montadora',null,'2025-05-14',88382,'carga planilha da unidade'),
  ('ANG','GEU7H35','montadora','MP1','2026-03-18',114496,'carga planilha da unidade'),
  ...
  ('ANG','GGA6G16','montadora','MP1','2026-05-07',90098,'carga planilha da unidade'),
  ...
  ('ANG','GJG9B11','montadora','MP1','2026-02-20',113825,'carga planilha da unidade'),
  ...
  ('ANG','SWF3D53','montadora','MP1','2026-05-07',46342,'carga planilha da unidade');
