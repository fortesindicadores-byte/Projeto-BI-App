...
- **STRESS TEST EMPILHADEIRA** (menu STRESS TEST; URL `bi/d1cead3d-e28a-487b-a1bd-8b72cdd6da55`): filtros Empresa/Regional/Filial/Tier/Contratada/Ano/**Mês**/Placa/Chassis Freightech — **sem slicer de Quinzena** (1ª e 2ª QZ são colunas). **Regra: até o dia 10, selecionar só Mês = mês anterior.** Exportar DUAS tabelas: (1) a detalhada **"Análise Descontos"** (Prop. FT | Empresa FT | Filial FT | Filial GINFO | Filial FT x GINFO | Marca | Perfil | Placa Ginfo | Chassis | Contratada | Parada?/Status Just./Motivo/Desconto por quinzena | Desc. Total) → chave `stress-test-empilhadeira`, alimenta a aba `Stress Test Empilhadeiras` do Farol; (2) a **2ª tabela** da página (por FILIAL, abaixo dos cards: Filial | Emp. Ginfo | Emp. Freightech | Divergência | 1ª/2ª QZ Paradas/Coletas/Stress Test/Desconto | Desconto Total) → chave `stress-test-empilhadeira-filial` (pedido 02/08/2026).
